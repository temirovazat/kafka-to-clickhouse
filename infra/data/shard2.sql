...
ENGINE = ReplicatedMergeTree('/clickhouse/tables/shard2/video_progress', 'replica_1')
...
ENGINE = ReplicatedMergeTree('/clickhouse/tables/shard1/video_progress', 'replica_2')
PARTITION BY toYYYYMMDD(event_time)
ORDER BY user_id;
